...
`action_wheel.lua` is a barebones example for how to use this project in most avatars. All you need to do is
...
If you don't already have an action wheel, then you can use this crazy one liner to initilize the action wheel and add the music player
